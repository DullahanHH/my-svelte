...
<div>
    ...
    <ProjectCard
            title="Glider Website"
            img=""
            description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus commodo hendrerit ipsum, ac porttitor ex
